  ...
  plugins: [
    ...
    plugin(function ({ addBase, addComponents, addUtilities }) {
      ...
      addComponents({
        ...
        ".btn-secondary": {
          "@apply btn bg-greyscale-0 dark:bg-dark-card border-greyscale-100 dark:border-dark-border text-greyscale-900 dark:text-dark-text-primary hover:bg-primary-300 hover:border-transparent":
            {},
        },
        ".btn-md": {
          "@apply h-12 px-6": {},
