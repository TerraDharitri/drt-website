    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-divider-light":
          "linear-gradient(to bottom, rgba(255,255,255, 0.15) 0, rgba(255,255,255, 0.15) 0.3125rem, transparent 0.3125rem, transparent 0.5rem)",
        "gradient-divider":
          "linear-gradient(to bottom, #D4D4D4 0, #D4D4D4 0.3125rem, transparent 0.3125rem, transparent 0.5rem)",
      },
    },
  },
  plugins: [
    ...
    plugin(function ({ addBase, addComponents, addUtilities }) {
      ...
      addComponents({
        ...
        ".btn-primary": {
          "@apply btn bg-primary-300 text-secondary-300 hover:bg-primary-100 dark:bg-primary-200 dark:text-secondary-300 dark:hover:bg-primary-300":
            {},
        },
        ".btn-secondary": {
          "@apply btn bg-greyscale-0 dark:bg-dark-surface border-greyscale-100 dark:border-dark-border text-greyscale-900 dark:text-dark-text-primary hover:bg-primary-300 hover:border-transparent dark:hover:bg-primary-300 dark:hover:text-secondary-300":
            {},
        },
        ".btn-md": {
          "@apply h-12 px-6": {},
