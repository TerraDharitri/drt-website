...
const Chain = () => {
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 text-gray-900 py-24">
      {/* Hero Section */}
      ...
      <section className="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl font-bold mb-6 text-blue-800">Enhanced Security</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition">
          <h3 className="text-2xl font-bold mb-4 text-blue-800">How It Works</h3>
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-6 py-16 text-center bg-blue-900 text-white rounded-lg shadow-lg">
