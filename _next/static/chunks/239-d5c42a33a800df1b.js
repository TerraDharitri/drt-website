...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [239],
  {
    4627: function (e, a, s) {
      ...
      a.Z = (e) => {
        ...
        return (0, t.jsxs)("label", {
          className:
            "group relative flex items-start select-none cursor-pointer tap-highlight-color ".concat(
              a || ""
            ),
          children: [
            (0, t.jsx)("input", {
            ...
            (0, t.jsx)("span", {
              className:
                "relative flex justify-center items-center shrink-0 w-5 h-5 mt-0.5 mr-3 rounded-md border border-greyscale-100 transition-colors group-hover:border-primary-300 ".concat(
                  c ? "bg-primary-300 !border-primary-300" : "bg-transparent"
                ),
              children: (0, t.jsx)(l.Z, {
                className: "fill-greyscale-0 transition-opacity ".concat(
            ...
            (0, t.jsx)("span", {
              className: "text-lg text-greyscale-400 ".concat(s || ""),
              children: r,
            }),
          ],
        });
      ...
      a.Z = (e) => {
        ...
        return (0, t.jsxs)("div", {
          ...
          children: [
            c &&
              (0, t.jsx)("div", {
                className: "mb-1.5 text-base font-semibold text-greyscale-700",
                children: c,
              }),
            (0, t.jsxs)("div", {
              className: "relative ".concat(n ? "text-0" : ""),
              children: [
                n
                  ? (0, t.jsx)("textarea", {
                      className: (0, l.m6)(
                        "w-full h-[8.25rem] px-3.5 py-2.5 bg-transparent border border-greyscale-100 rounded-lg shadow-[0_0.0625rem_0.125rem_0_rgba(16,24,40,0.05)] text-lg text-greyscale-900 outline-none transition-colors placeholder:text-greyscale-300 resize-none focus:!border-primary-300 ".concat(
                          s || ""
                        )
                      ),
                      value: o,
                ...
                "password" === i &&
                  (0, t.jsx)("button", {
                    className:
                      "group absolute top-0 right-0 bottom-0 w-12 text-0",
                    type: "button",
                    children: (0, t.jsx)(r.Z, {
                      className:
                        "fill-greyscale-300 transition-colors group-hover:fill-primary-100",
                      name: "eye",
                    }),
                  }),
              ],
    ...
    9602: function (e, a, s) {
      ...
      a.Z = (e) => {
        let { className: a, name: s, fill: c } = e;
        return (0, t.jsx)("svg", {
          className: (0, l.m6)("inline-flex w-6 h-6 ".concat(a || "")),
          width: 24,
          height: 24,
          viewBox: "0 0 24 24",
          children: (0, t.jsx)("path", { fill: c, d: r[s] }),
        });
      };
    },
    5996: function (e, a, s) {
    ...
    7239: function (e, a, s) {
      ...
      var i = (e) => {
          let {} = e;
          return (0, t.jsx)("div", {
            className: "flex p-2.5 lg:hidden",
            children: (0, t.jsxs)("div", {
              className: "relative flex items-center grow bg-secondary-300",
              children: [
                (0, t.jsx)("div", {
                  className:
                    "relative z-2 w-[55rem] py-8 4xl:w-[41.875rem] 2xl:w-[36rem] xl:w-[30rem]",
                  children: (0, t.jsx)(c.tv, {
                    className: "splide-login",
                    options: { arrows: !1, rewind: !0, gap: "1rem" },
                    children: n.map((e, a) =>
                      (0, t.jsxs)(
                        c.jw,
                        {
                          ...
                          children: [
                            (0, t.jsx)("div", {
                              className:
                                "relative w-[28.75rem] h-[22.5rem] mx-auto mb-12 xl:w-auto xl:h-[18rem] xl:mx-6",
                            ...
                            (0, t.jsxs)("div", {
                              className:
                                "max-w-[28.125rem] mx-auto text-center",
                              children: [
                                (0, t.jsx)("div", {
                                  className:
                                    "mb-4 text-h5 text-greyscale-0 xl:text-h6",
                                  children: e.title,
                                }),
                                (0, t.jsx)("div", {
                ...
                (0, t.jsx)("div", {
                  className:
                    "absolute top-0 left-12 right-12 bottom-0 flex justify-between pointer-events-none",
                  children: Array.from([, , , , ,].keys()).map((e) =>
                    (0, t.jsx)(
                      "div",
                      {
                        className:
                          "w-0.25 bg-repeat bg-[length:100%_.5rem] opacity-60 bg-gradient-divider-light",
                      },
                      e
                    )
                  ),
        ...
        x = (e) => {
          ...
          return (0, t.jsxs)("form", {
            ...
            children: [
              ...
              (0, t.jsxs)("div", {
                className: "flex justify-between items-center mb-10 md:mb-6",
                children: [
                  (0, t.jsx)(d.Z, {
                  ...
                  (0, t.jsx)(r(), {
                    className:
                      "text-lg font-medium text-secondary-300 transition-colors hover:text-primary-100",
        ...
        h = (e) => {
          ...
          return (0, t.jsxs)("form", {
            ...
            children: [
              (0, t.jsxs)("div", {
                className: "flex mb-4 space-x-4 md:space-x-3 md:mb-3",
                children: [
                  (0, t.jsx)(m.Z, {
                    className: "flex-1",
                    classInput: "h-12",
        ...
        u = (e) => {
          let { signUp: a } = e;
          return (0, t.jsxs)("div", {
            className: "flex min-h-screen min-h-screen-ios",
            children: [
              (0, t.jsx)(i, {}),
              (0, t.jsx)("div", {
                className: "flex items-center grow p-8 md:px-6",
                children: (0, t.jsxs)("div", {
                  className: "max-w-[31.875rem] w-full mx-auto",
                  children: [
                    (0, t.jsx)("div", {
                      className: "mb-4 text-center text-h5 md:h-6",
                      children: a
                        ? "Sign up to Dharitri"
                        : "Sign in to Dharitri",
                    }),
                    (0, t.jsx)("div", {
                      className:
                        "mb-10 text-center text-lg text-greyscale-400 md:mb-6",
                      children: "Send, spend and save smarter",
                    }),
                    (0, t.jsxs)("div", {
                      className:
                        "flex space-x-4 mb-5 md:block md:mb-4 md:space-x-0 md:space-y-4",
                      children: [
                        (0, t.jsxs)("button", {
                          className:
                            "btn-secondary btn-md flex-1 rounded-lg md:w-full",
                          children: [
                            (0, t.jsx)(Image.Z, {
                    ...
                    (0, t.jsxs)("div", {
                      className: "flex items-center mb-5 md:mb-4",
                      children: [
                        (0, t.jsx)("div", {
                          className: "grow h-0.25 bg-greyscale-100",
                        }),
                        (0, t.jsx)("div", {
                          className: "mx-3 text-base text-greyscale-400",
                    ...
                    a ? (0, t.jsx)(h, {}) : (0, t.jsx)(x, {}),
                    (0, t.jsxs)("div", {
                      className:
                        "mt-10 text-center text-lg text-greyscale-400 md:mt-6",
                      children: [
                        "Don’t have an account?",
                        " ",
                        (0, t.jsx)(r(), {
                          className:
                            "font-semibold text-greyscale-900 transition-colors hover:text-primary-100",
                          href: a ? "/sign-in" : "sign-up",
