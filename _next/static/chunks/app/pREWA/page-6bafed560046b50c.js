(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    7363: function (e, s, t) {
      Promise.resolve().then(t.bind(t, 4660));
    },
    4660: function (e, s, t) {
      "use strict";
      t.r(s),
      ...
      var a = t(7437),
        ...
        d = () =>
          (0, a.jsx)(n.Z, {
            className: "bg-secondary-300 text-greyscale-0",
            hero: !0,
            light: !0,
            children: (0, a.jsx)("div", {
              className: "py-22 md:pt-12 md:pb-6",
              children: (0, a.jsx)("div", {
                className: "container",
                children: (0, a.jsxs)("div", {
                  className: "flex items-center mb-22 lg:block md:mb-6",
                  children: [
                    (0, a.jsxs)("div", {
                      className: "grow pr-10 lg:pr-0",
                      children: [
                        (0, a.jsx)("div", {
                          className: "mb-4 text-h1 xl:text-h2 md:text-h3",
                          children:
                            "pREWA Token: Fund Farmers, Earn Staking Rewards",
                        }),
                        (0, a.jsx)("div", {
                          className: "mb-10 text-white/70 md:text-lg",
                          children:
                    ...
                    (0, a.jsx)("div", {
                      className:
                        "relative shrink-0 w-[49.48%] lg:w-full lg:mt-16 md:mt-8 flex justify-center",
                      children: (0, a.jsx)(Image.Z, {
        ...
        x = () =>
          (0, a.jsx)("div", {
            ...
            children: (0, a.jsx)("div", {
              ...
              children: (0, a.jsxs)("div", {
                className:
                  "flex items-center gap-20 xl:gap-12 lg:block lg:gap-0",
                children: [
                  (0, a.jsx)("div", {
                    className: "flex-1 lg:mb-10 flex justify-center",
                    children: (0, a.jsx)(Image.Z, {
                      className:
                        "w-full h-auto object-contain max-w-[300px] max-h-[300px]",
                  ...
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      (0, a.jsx)("div", {
                        className:
                          "mb-4 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                        children: "What is pREWA",
                      }),
                      (0, a.jsxs)("div", {
                        className:
                          "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base space-y-4",
                        children: [
                          (0, a.jsx)("p", {
                            children:
        ...
        m = () =>
          (0, a.jsx)("div", {
            className: "section bg-greyscale-25 dark:bg-dark-surface",
            children: (0, a.jsx)("div", {
              className: "container",
              children: (0, a.jsxs)("div", {
                className:
                ...
                children: [
                  (0, a.jsxs)("div", {
                    className: "flex-[3] lg:mb-10",
                    children: [
                      (0, a.jsx)("div", {
                        className:
                          "mb-4 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                        children: "pREWA: Platform Launch Fund",
                      }),
                      (0, a.jsx)("div", {
                        className:
                          "mb-6 text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                        children:
                      ...
                      (0, a.jsxs)("ul", {
                        className: "mb-8 list-none space-y-2",
                        children: [
                          (0, a.jsxs)("li", {
                            ...
                            children: [
                              (0, a.jsx)("div", {
                                className:
                                  "flex justify-center items-center w-6 h-6 rounded-full bg-[#9FE870] shrink-0 mt-1",
                                children: (0, a.jsx)(Image.Z, {
                              ...
                              (0, a.jsx)("span", {
                                className: "ml-2  dark:text-dark-text-primary",
                                children:
                      ...
                      (0, a.jsx)("div", {
                        className:
                          "mb-8 text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                        children:
                      ...
                      (0, a.jsxs)(l(), {
                        ...
                        children: [
                          (0, a.jsx)("span", { children: "Read White Paper" }),
                          (0, a.jsx)(c.Z, {
                            className: "w-5 h-5",
                            name: "arrow-right",
                          }),
                  ...
                  (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(Image.Z, {
                      className:
                        "w-full h-auto object-contain max-w-[400px] max-h-[300px]",
              ...
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("h2", {
                      className:
                        "text-h2 xl:text-h3 md:text-h4 font-semibold mb-4 dark:text-dark-text-primary",
                      children: "Token Sale Proceeds Usage",
                    }),
                    (0, a.jsx)("p", {
                      className:
                        "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                      children:
                ...
                (0, a.jsx)("div", {
                  className:
                    "grid grid-cols-3 gap-8 lg:grid-cols-2 md:grid-cols-1",
                  children: h.map((e, s) =>
                    (0, a.jsxs)(
                      "div",
                      {
                        className:
                          "p-6 bg-greyscale-0 dark:bg-dark-card border border-greyscale-100 dark:border-dark-border shadow-2 rounded-lg",
                        children: [
                          (0, a.jsx)("div", {
                            className:
                              "flex justify-center items-center w-12 h-12 mb-6 rounded-full bg-[#9FE870]",
                            children: (0, a.jsx)(Image.Z, {
                              src: e.icon,
                              className: "w-6",
                              width: 24,
                          ...
                          (0, a.jsx)("div", {
                            className:
                              "mb-3 text-h6 font-semibold dark:text-dark-text-primary",
                            children: e.title,
                          }),
                          (0, a.jsx)("div", {
                            className:
                              "text-greyscale-400 dark:text-dark-text-secondary",
                            children: e.content,
                          }),
                        ],
                      },
              ...
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        "mb-6 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                      children: "Stake pREWA: Earn Rewards",
                    }),
                    (0, a.jsx)("div", {
                      className:
                        "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                ...
                (0, a.jsxs)("div", {
                  className:
                    "flex items-center gap-20 xl:gap-12 lg:flex-col lg:gap-12",
                  children: [
                    (0, a.jsx)("div", {
                      className: "flex-1 lg:w-full flex justify-center",
                      children: (0, a.jsx)(Image.Z, {
                        className:
                          "w-full h-auto object-contain max-w-[400px] max-h-[300px]",
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        (0, a.jsx)("div", {
                          className:
                            "mb-8 text-h3 xl:text-h4 md:text-h5 dark:text-dark-text-primary",
                          children: "What is pREWA Staking?",
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-8 text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                        ...
                        (0, a.jsx)("div", {
                          className:
                            "mb-6 text-lg text-greyscale-400 font-semibold dark:text-dark-text-primary",
                          ...
                          children: [
                            (0, a.jsxs)("li", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("span", {
                                  className:
                                    "ml-2  dark:text-dark-text-primary",
                                  children:
        ...
        p = () =>
          (0, a.jsx)("div", {
            ...
            children: (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  className: "mb-20 lg:mb-16 md:mb-12",
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        "mb-6 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary font-semibold",
                      children: "Bridge to Native REWA Token",
                    }),
                    (0, a.jsx)("div", {
                      className:
                        "text-greyscale-400 dark:text-dark-text-secondary text-xl lg:text-lg md:text-base leading-relaxed",
                      children:
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                      ...
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)("div", {
                              className:
                                "mb-6 text-h4 xl:text-h4 md:text-h5 dark:text-dark-text-primary font-semibold",
                              children: "REWA: Native PoS Token",
                            }),
                            (0, a.jsx)("div", {
                              className:
                                "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base leading-relaxed",
                              children:
                        ...
                        (0, a.jsxs)("ul", {
                          className: "mb-12 lg:mb-8 space-y-4",
                          children: [
                            (0, a.jsxs)("li", {
                        ...
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)("div", {
                              className:
                                "mb-4 text-h4 xl:text-h4 md:text-h5 dark:text-dark-text-primary font-semibold",
                              children: "Smooth Staking Transition",
                            }),
                            (0, a.jsx)("div", {
                              className:
                                "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base leading-relaxed",
                    ...
                    (0, a.jsx)("div", {
                      className:
                        "flex-1 lg:w-full flex justify-center items-center",
                      children: (0, a.jsx)(Image.Z, {
                        className:
                          "w-full h-auto object-contain max-w-[500px] xl:max-w-[450px] lg:max-w-[400px] md:max-w-[350px]",
              ...
              children: [
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        "flex-1 flex justify-center items-center lg:w-full lg:mb-10",
                      children: (0, a.jsx)(Image.Z, {
                        className:
                          "w-full h-auto object-contain max-w-[500px] max-h-[400px]",
                      ...
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)("div", {
                              className:
                                "mb-6 text-h3 xl:text-h4 md:text-h5 dark:text-dark-text-primary",
                              children: "Purchase Steps",
                            }),
                            (0, a.jsxs)("ul", {
                              className: "space-y-4",
                              children: [
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        "mb-4 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                      children: "pREWA Contract Address",
                    }),
                    (0, a.jsx)("div", {
                      className:
                        "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                  ...
                  children: [
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, a.jsx)("div", {
                              className:
                                "mb-6 text-h3 xl:text-h4 md:text-h5 dark:text-dark-text-primary",
                              children: "Token Specifications",
                            }),
                            (0, a.jsx)("div", {
                              className:
                                "text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                              children:
                                "Rewa is our native token for utility, governance, and crypto staking. Our L1 blockchain depends on pREWA for three key functions:",
                            }),
                          ],
                        }),
                        (0, a.jsxs)("ul", {
                            ...
                            (0, a.jsxs)("li", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("span", {
                                  className:
                                    "ml-2  dark:text-dark-text-primary",
                                  children: "Network:Binance Smart Chain BSC",
                                }),
                              ],
                            }),
                            (0, a.jsxs)("li", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("span", {
                                  className:
                                    "ml-2  dark:text-dark-text-primary",
                                  children: "Standard:BEP20 for wallet support",
                                }),
                              ],
                            }),
                            (0, a.jsxs)("li", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("span", {
                                  className:
                                    "ml-2  dark:text-dark-text-primary",
                                  children: "Symbol:pREWA for identification",
                                }),
                              ],
                            }),
                            (0, a.jsxs)("li", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("span", {
                                  className:
                                    "ml-2  dark:text-dark-text-primary",
                                  children: "Supply: 500 million tokens",
                                }),
                              ],
                            }),
                          ],
                        ...
                        (0, a.jsx)("div", {
                          className:
                            "mb-4 text-h3 xl:text-h4 md:text-h5 dark:text-dark-text-primary",
      ...
      var f = () =>
          (0, a.jsx)("div", {
            className: "section bg-greyscale-25 dark:bg-dark-surface py-24",
            children: (0, a.jsxs)("div", {
              className: "container",
              children: [
                (0, a.jsxs)("div", {
                  className:
                    "flex items-center justify-center gap-24 xl:gap-20 lg:flex-col lg:gap-16 mb-20",
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        " basis-[45%] flex-shrink-0 w-[500px] xl:w-[450px] lg:w-full lg:max-w-[450px] lg:mx-auto mb-8",
                      children: (0, a.jsx)(Image.Z, {
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        (0, a.jsx)("div", {
                          className:
                            "mb-4 text-h2 text-start xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                          children: "Key Risks & Token Warnings",
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-6 text-greyscale-500 dark:text-dark-text-secondary",
                          children:
                            "Crypto investments like pREWA carry high risks, including potential total loss. pREWA is an interim utility token with volatile value, funding our farmer solutions.",
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-6 text-greyscale-500 dark:text-dark-text-secondary",
                        ...
                        (0, a.jsx)("div", {
                          className:
                            "mb-8 text-greyscale-500 dark:text-dark-text-secondary",
                          children:
                        ...
                        (0, a.jsxs)(l(), {
                          ...
                          href: "",
                          children: [
                            (0, a.jsx)("span", { children: "View Full T&Cs" }),
                            (0, a.jsx)(c.Z, {
                              className: "w-5 h-5",
                              name: "arrow-right",
                            }),
                ...
                (0, a.jsx)("div", {
                  className: "grid grid-cols-3 gap-8 lg:grid-cols-1 lg:gap-6",
                  children: u.map((e, s) =>
                    (0, a.jsx)(
                      "div",
                      {
                        className:
                          "p-8 bg-greyscale-0 dark:bg-dark-card border border-greyscale-100 dark:border-dark-border rounded-lg",
                        children: (0, a.jsxs)("div", {
                          className: "text-center",
                          children: [
                            (0, a.jsx)("div", {
                              className:
                                "flex justify-center items-center w-12 h-12  mb-6 rounded-full bg-[#9FE870] dark:bg-primary-900/30",
                              children: (0, a.jsx)(Image.Z, {
                                src: e.icon,
                                className: "w-6 h-6",
                                width: 24,
                            ...
                            (0, a.jsx)("div", {
                              className:
                                "mb-3 text-xl font-bold text-start dark:text-dark-text-primary",
                              children: e.title,
                            }),
                            (0, a.jsx)("div", {
                              className:
                                "text-greyscale-500 text-start dark:text-dark-text-secondary leading-relaxed",
                              children: e.content,
                            }),
                          ],
                        }),
            ...
            children: (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsx)("div", {
                  className:
                    "mb-6 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                  children: "Join Our Community & Learn More",
                }),
                (0, a.jsx)("div", {
                  className:
                    "mb-8 text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                  children:
                    "Keep up with pREWA news on our Telegram. Want to know more about Dharitri? Check out the links below.",
                }),
                (0, a.jsxs)("div", {
                  className:
                    "flex items-center gap-20 xl:gap-12 lg:block lg:gap-0",
                  children: [
                    (0, a.jsxs)("div", {
                      className: "flex-1 lg:w-full lg:mb-10",
                      children: [
                        (0, a.jsxs)("div", {
                          className: "mb-8",
                          children: [
                            (0, a.jsx)("div", {
                              className:
                                "mb-6 text-h5 xl:text-h5 md:text-h6 dark:text-dark-text-primary",
                              ...
                              children: [
                                (0, a.jsxs)("div", {
                                  ...
                                  children: [
                                    (0, a.jsx)("div", {
                                      className:
                                        "flex justify-center items-center w-6 h-6 rounded-full bg-[#9FE870] shrink-0 mt-1 mr-2",
                                      children: (0, a.jsx)(Image.Z, {
                                        src: "images/content/icons/check-bold.svg",
                                        className: "w-3 h-3",
                                        width: 12,
                                    ...
                                    (0, a.jsxs)("div", {
                                      children: [
                                        (0, a.jsx)("span", {
                                          className:
                                            "text-greyscale-400 dark:text-dark-text-secondary",
                                          children: "Read Our White Paper:",
                                        }),
                                        (0, a.jsx)("span", {
                                          className:
                                            " dark:text-dark-text-secondary ml-1",
                                          children:
                                  ...
                                  children: [
                                    ...
                                    (0, a.jsxs)("div", {
                                      children: [
                                        (0, a.jsx)("span", {
                                          className:
                                            "text-greyscale-400 dark:text-dark-text-primary",
                                          children: "Our Mission for Farmers:",
                                        }),
                                        (0, a.jsx)("span", {
                                          className:
                                            " dark:text-dark-text-secondary ml-1",
                                    ...
                                    (0, a.jsxs)("div", {
                                      children: [
                                        (0, a.jsx)("span", {
                                          className:
                                            "text-greyscale-400 dark:text-dark-text-primary",
                                          children: "Meet the Dharitri Team:",
                                        }),
                                        (0, a.jsx)("span", {
                                          className:
                                            " dark:text-dark-text-secondary ml-1",
                        ...
                        (0, a.jsx)("div", {
                          className:
                            "mb-8 text-greyscale-400 dark:text-dark-text-secondary",
                          children:
                          ...
                          children: [
                            (0, a.jsx)(l(), {
                              ...
                              children: (0, a.jsxs)("svg", {
                                ...
                                children: [
                                  (0, a.jsxs)("g", {
                                    "clip-path": "url(#clip0_6023_10375)",
                                    children: [
                                      (0, a.jsx)("path", {
                            ...
                            (0, a.jsx)(l(), {
                              ...
                              children: (0, a.jsxs)("svg", {
                                ...
                                children: [
                                  (0, a.jsx)("g", {
                                    "clip-path": "url(#clip0_6023_10378)",
                                    children: (0, a.jsx)("path", {
        ...
        b = () =>
          (0, a.jsx)("div", {
            className: "section bg-secondary-300 text-greyscale-0",
            children: (0, a.jsx)("div", {
              className: "container",
              children: (0, a.jsxs)("div", {
                className: "text-center",
                children: [
                  (0, a.jsx)("div", {
                    className: "mb-6 text-h2 xl:text-h2 md:text-h3 text-white",
                    children: "Ready to Help Farmers?",
                  }),
                  (0, a.jsx)("div", {
                    className:
                      "mb-10 text-white/70 text-lg md:text-base mx-auto",
                    children:
                      "Your support helps us build real solutions for farming communities worldwide.",
                  }),
                  (0, a.jsxs)("div", {
                    className:
                      "flex justify-center space-x-4 md:block md:space-x-0 md:space-y-4 md:max-w-sm md:mx-auto",
                    children: [
                      (0, a.jsx)(l(), {
                        className:
                          "btn-primary min-w-[10.6rem] px-5 md:min-w-full",
                        href: "/get-involved",
                        children: "Get Involved",
                      }),
                      (0, a.jsx)(l(), {
                        className:
                          "btn-secondary min-w-[10.6rem] px-5 md:min-w-full",
                        href: "/ecosystem",
                        children: "See Our Platform",
                      }),
                    ],
                  }),
                ],
  ...
  function (e) {
    e.O(0, [326, 33, 73, 785, 971, 472, 744], function () {
      return e((e.s = 7363));
    }),
      (_N_E = e.O());
  },
