(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    4537: function (e, s, t) {
      Promise.resolve().then(t.bind(t, 9901));
    },
    9901: function (e, s, t) {
      "use strict";
      t.r(s),
              ...
              children: (0, a.jsx)("div", {
                ...
                children: (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      className:
                        "mb-4 text-h1 text-white xl:text-h2 md:text-h4",
      ...
      var m = (e) => {
          ...
          return (0, a.jsx)("div", {
            ...
            children: (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)("div", {
                className:
                  "space-y-20 xl:space-y-24 lg:space-y-20 md:space-y-12 pt-20",
                children: c.map((e, s) =>
                  (0, a.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, a.jsx)("div", {
                              className:
                                "mb-12 text-greyscale-400 md:mb-6 md:text-lg",
                              children: e.content,
                            }),
                          ],
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "w-[calc(50%-5rem)] mx-20 2xl:w-[calc(50%-2.5rem)] 2xl:mx-10 xl:w-[calc(50%-1.25rem)] xl:mx-5 lg:w-full lg:mx-0",
        ...
        return (0, a.jsx)(o.Z, {
          ...
          children: (0, a.jsxs)("div", {
            ...
            children: [
              ...
              (0, a.jsx)("div", {
                className: "mb-20 text-h3 xl:mb-16 xl:text-h4 lg:mb-12 md:mb-8",
                children: "Our Mission & Vision Statement",
              }),
              (0, a.jsxs)("div", {
                className: "flex space-x-10 lg:block lg:space-x-0",
                children: [
                  (0, a.jsx)("div", {
                      ...
                      (0, a.jsxs)(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            (0, a.jsx)("div", {
                              className:
                                "text-greyscale-400 dark:text-dark-text-secondary xl:text-lg lg:text-xl",
                              children: e.content,
                            }),
                          ],
                        },
        ...
        return (0, a.jsx)("div", {
          ...
          children: (0, a.jsxs)("div", {
            ...
            children: [
              (0, a.jsxs)("div", {
                ...
                children: [
                  (0, a.jsx)("h2", {
                    ...
                    children: "Our Core Values & Principles",
                  }),
                  (0, a.jsx)("p", {
                    className:
              ...
              (0, a.jsx)("div", {
                className:
                  "grid gap-8 grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1",
                children: h.map((e, s) =>
                  (0, a.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        (0, a.jsx)("div", {
                          className: "mb-3 text-h6 dark:text-dark-text-primary",
                          children: e.title,
                        }),
                        (0, a.jsx)("div", {
                          className:
                      ...
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, a.jsx)("ul", {
                              className:
                                "mb-12 list-disc list-inside text-greyscale-400 md:mb-6 md:text-lg space-y-2",
                              children: (() => {
                                let s = [];
