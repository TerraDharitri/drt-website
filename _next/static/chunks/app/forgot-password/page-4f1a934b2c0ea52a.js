(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    3357: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 4783));
    },
    8805: function (e, t, r) {
      "use strict";
      var s = r(7437);
      t.Z = (e) => {
        let { className: t, classInner: r, hero: a, light: c, children: l } = e;
        return (0, s.jsx)("div", {
          className: "relative "
            .concat(a ? "pt-22 md:pt-18" : "", " ")
            .concat(t || ""),
          children: (0, s.jsx)("div", {
            className: "relative z-2 ".concat(r || ""),
            children: l,
          }),
        });
      };
    ...
    9602: function (e, t, r) {
      ...
      t.Z = (e) => {
        let { className: t, name: r, fill: l } = e;
        return (0, s.jsx)("svg", {
          className: (0, a.m6)("inline-flex w-6 h-6 ".concat(t || "")),
          width: 24,
          height: 24,
          viewBox: "0 0 24 24",
          children: (0, s.jsx)("path", { fill: l, d: c[r] }),
        });
      };
    },
    5996: function (e, t, r) {
    ...
    4783: function (e, t, r) {
      ...
      t.default = () => {
        ...
        return (0, s.jsxs)(n.Z, {
          className:
            "flex flex-col min-h-screen bg-secondary-300 min-h-screen-ios",
          classInner: "flex flex-col grow",
          light: !0,
          children: [
            (0, s.jsx)("div", {
              className: "border-b border-white/[.09] bg-secondary-300",
              children: (0, s.jsxs)("div", {
                className: "container-md flex items-center h-22 md:h-18",
                children: [
                  (0, s.jsx)(l(), {
                    className: "w-26 mr-auto md:w-22",
                    href: "/",
                  ...
                  (0, s.jsxs)("div", {
                    className: "flex items-center ml-auto space-x-3",
                    children: [
                      (0, s.jsx)(l(), {
                        className:
                          "btn-secondary bg-transparent btn-sm text-greyscale-0 hover:border-primary-300 hover:bg-primary-300 hover:text-greyscale-900 md:h-8 md:px-3 md:text-sm",
                        href: "/sign-in",
                        children: "Sign In",
                      }),
                      (0, s.jsx)(l(), {
                        className:
                          "btn-primary btn-sm md:h-8 md:px-3 md:text-sm",
                        href: "/sign-up",
            ...
            (0, s.jsx)("div", {
              className: "flex justify-center items-center grow p-8 md:px-6",
              children: (0, s.jsxs)("div", {
                className:
                  "max-w-[31.25rem] w-full px-10 py-14 bg-greyscale-0 md:px-6 md:py-8",
                children: [
                  (0, s.jsx)("div", {
                    className:
                      "flex justify-center items-center w-16 h-16 mx-auto mb-5 bg-primary-300 border-[0.625rem] border-primary-25 rounded-full md:w-14 md:h-14 md:border-[0.5rem]",
                    children: (0, s.jsx)(i.Z, {
                  ...
                  (0, s.jsx)("div", {
                    className: "mb-3 text-center text-h5 md:text-h6",
            ...
            (0, s.jsx)("div", {
              className: "border-t border-white/[.09] bg-secondary-300",
              children: (0, s.jsxs)("div", {
                className:
                  "container-md flex justify-between items-center h-22 md:block md:h-auto md:py-5",
                children: [
                  (0, s.jsxs)("div", {
                    className:
                      "flex items-center text-lg text-white/50 md:justify-center md:mb-4",
                    children: [
                      (0, s.jsx)(o.Z, {
                        className: "w-5 h-5 mr-1 fill-white/50",
                        name: "copyright",
                      }),
                      "2023 Dharitri. All right reserved",
                    ],
                  }),
                  (0, s.jsx)("div", {
                    ...
                    children: d.U.map((e) =>
                      (0, s.jsx)(
                        ...
                        {
                          className:
                            "group opacity-50 text-0 transition-opacity hover:opacity-100",
                          href: e.url,
                          target: "_blank",
  ...
  function (e) {
    e.O(0, [326, 33, 971, 472, 744], function () {
      return e((e.s = 3357));
    }),
      (_N_E = e.O());
  },
