(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    8739: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 3826));
    },
    3826: function (e, t, s) {
      "use strict";
      s.r(t),
                ...
                children: (0, a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        "Dive deeper into how our full ecosystem functions, or directly support",
                        (0, a.jsx)("br", {}),
                        " Dharitri's development through the pREWA token:",
                      ],
                    }),
                    (0, a.jsxs)("div", {
                      className:
      ...
      let d = [
        {
          ...
          image:
            "images/graphics/The Solution/The Solution/technology farmer.svg",
      ...
      var o = (e) => {
        ...
        return (0, a.jsxs)("div", {
          children: [
            (0, a.jsx)(n.Z, {
              className: "bg-white text-greyscale-900",
              hero: !0,
              children: (0, a.jsx)("div", {
                ...
                children: (0, a.jsx)("div", {
                  ...
                  children: (0, a.jsxs)("div", {
                    ...
                    children: [
                      (0, a.jsxs)("div", {
                        className: "basis-[70%] grow pr-10 lg:pr-0",
                        children: [
                          (0, a.jsxs)("div", {
                          ...
                          (0, a.jsx)("div", {
                            className: "mb-10 text-greyscale-600 md:text-lg",
                            children:
                      ...
                      (0, a.jsx)("div", {
                        className:
                          "basis-[30%] lg:mt-16 md:mt-8 flex justify-center",
                  ...
                  children: (0, a.jsx)("div", {
                    ...
                    children: d.map((e, t) =>
                      (0, a.jsxs)(
                        ...
                        {
                          className:
                            "flex items-center gap-20 xl:gap-10 lg:block",
                          children: [
                            (0, a.jsxs)("div", {
                              className: "w-1/2 lg:w-full lg:mb-10",
                              children: [
                                (0, a.jsx)("div", {
                                  className: "stage",
                                  children: e.stage,
                                ...
                                (0, a.jsx)("div", {
                                  className:
                                    "mb-12 text-greyscale-400 dark:text-dark-text-secondary md:mb-6 md:text-lg",
                                  children: e.content,
                                }),
                              ],
                            }),
      ...
      var x = (e) => {
          ...
          return (0, a.jsx)("div", {
            className:
              "pt-30 pb-22 xl:pt-24 xl:pb-20 md:py-12 bg-greyscale-25 dark:bg-dark-surface",
            children: (0, a.jsxs)("div", {
              className: "container",
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("h2", {
                      className:
                        "text-h2 xl:text-h3 md:text-h4 font-semibold mb-6 dark:text-dark-text-primary",
                      children: "Why We Choose This Blockchain",
                    }),
                    (0, a.jsx)("p", {
                      className:
          ...
          return (0, a.jsx)("div", {
            ...
            children: (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  className:
                    "flex items-center gap-20 xl:gap-10 mb-14 lg:flex-col lg:items-stretch md:mb-8 pt-20 pb-20",
                  children: [
                    (0, a.jsxs)("div", {
                      className: "w-[60%] lg:w-full lg:mb-10 md:mb-8",
                      children: [
                        (0, a.jsx)("div", { className: "stage" }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-4 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                          children: "Building Solutions in Steps",
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-4 text-h4 xl:text-h5 md:text-h6 dark:text-dark-text-primary",
                          children: "Why We Build This Way",
                        }),
                        (0, a.jsx)("div", {
                          className:
                            "mb-12 text-greyscale-400 dark:text-dark-text-secondary lg:mb-8 md:mb-6",
                          children:
                            "Our solutions are built methodically, step by step. This lets us adapt from real-world feedback and introduce useful services progressively. We earn trust with measurable outcomes and build partnerships responsibly. Each step improves the Dharitri system for the long term.",
                        }),
                        (0, a.jsxs)(l(), {
                    ...
                    (0, a.jsx)("div", {
                      className: "w-[40%] lg:w-full flex justify-center",
                      children: (0, a.jsx)(Image.Z, {
                        className: "w-full max-w-[400px] h-auto",
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("h2", {
                      ...
                      children: "Phase One: Launch Tools",
                    }),
                    (0, a.jsx)("p", {
                      className:
                        "mt-4 max-w-3xl mx-auto text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                ...
                (0, a.jsx)("div", {
                  className:
                    "grid grid-cols-3 gap-8 lg:grid-cols-2 md:grid-cols-1 mb-20",
                  children: g.map((e, t) =>
                    (0, a.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          (0, a.jsx)("div", {
                            className:
                              "mb-3 text-h6 text-start font-semibold dark:text-dark-text-primary",
                            children: e.title,
                          }),
                          (0, a.jsx)("div", {
                            className:
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("h2", {
                      className:
                        "text-h2 xl:text-h3 md:text-h4 font-semibold mb-4 dark:text-dark-text-primary",
                      children: "Phase Two: More Features",
                    }),
                    (0, a.jsx)("p", {
                      className:
                        "mt-4 max-w-3xl mx-auto text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("h2", {
                      className:
                        "text-h2 xl:text-h3 md:text-h4 font-semibold mb-4 dark:text-dark-text-primary",
                      children: "Phase Three: Full Vision",
                    }),
                    (0, a.jsx)("p", {
                      className:
                        "mt-4 max-w-3xl mx-auto text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base",
            ...
            children: (0, a.jsx)("div", {
              ...
              children: (0, a.jsxs)("div", {
                ...
                children: [
                  (0, a.jsx)("div", {
                    className:
                      "w-1/2 lg:w-full lg:mb-10 md:mb-8 flex justify-center",
                    children: (0, a.jsx)(Image.Z, {
                      className: "w-full max-w-[400px] h-auto",
                  ...
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, a.jsx)("div", {
                        className:
                          "mb-4 text-h2 xl:text-h3 md:text-h4 dark:text-dark-text-primary",
                        children: "Our Current Development Status",
                      }),
                      (0, a.jsx)("div", {
                        className:
                          "mb-12 text-greyscale-400 dark:text-dark-text-secondary lg:mb-8 md:mb-6",
                        children:
                          "Our platform development focuses on creating robust, farmer-centered solutions. We prioritize security, scalability, and real-world testing to ensure our technology genuinely serves smallholder farmers. Each feature is built with careful attention to local contexts and validated through community feedback.",
                      }),
                      (0, a.jsxs)(l(), {
                        className: "btn-primary pr-5.5 md:w-full",
                        href: "/pricing",
