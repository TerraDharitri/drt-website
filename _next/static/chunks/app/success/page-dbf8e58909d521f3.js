(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    3690: function (e, c, a) {
      Promise.resolve().then(a.bind(a, 7868));
    },
    8805: function (e, c, a) {
      "use strict";
      var s = a(7437);
      c.Z = (e) => {
        let { className: c, classInner: a, hero: t, light: l, children: i } = e;
        return (0, s.jsx)("div", {
          className: "relative "
            .concat(t ? "pt-22 md:pt-18" : "", " ")
            .concat(c || ""),
          children: (0, s.jsx)("div", {
            className: "relative z-2 ".concat(a || ""),
            children: i,
          }),
        });
      };
    ...
    9602: function (e, c, a) {
      ...
      c.Z = (e) => {
        let { className: c, name: a, fill: i } = e;
        return (0, s.jsx)("svg", {
          className: (0, t.m6)("inline-flex w-6 h-6 ".concat(c || "")),
          width: 24,
          height: 24,
          viewBox: "0 0 24 24",
          children: (0, s.jsx)("path", { fill: i, d: l[a] }),
        });
      };
    },
    5996: function (e, c, a) {
    ...
    7868: function (e, c, a) {
      ...
      c.default = () =>
        (0, s.jsxs)(i.Z, {
          className:
            "flex flex-col min-h-screen min-h-screen-ios bg-secondary-300",
          ...
          children: [
                ...
                children: [
                  ...
                  (0, s.jsx)(l(), {
                    ...
                    children: (0, s.jsx)(r.Z, {
                      className:
                        "w-8 h-8 fill-greyscale-0 transition-colors group-hover:fill-primary-300",
                      name: "close",
                    }),
                  }),
                ],
            ...
            (0, s.jsx)("div", {
              className:
                "flex justify-center items-center grow pt-4 px-8 pb-16",
              children: (0, s.jsxs)("div", {
                className:
                  "max-w-[32.2rem] w-full text-center text-greyscale-0",
                children: [
                  (0, s.jsx)("div", {
                  ...
                  (0, s.jsx)("div", {
                    className:
                      "max-w-[27.5rem] mx-auto mb-4 text-h4 md:text-h5",
                    children: "Successfully Created Your Account!",
                  }),
                  (0, s.jsx)("div", {
                    className: "mb-10 opacity-50 md:mb-6 md:text-lg",
                    children:
                      "Lorem ipsum dolor sit amet consectetur. Sit sed turpis magna habitant leo ac ante. Quam volutpat vitae nisi",
                  }),
                  (0, s.jsx)(l(), {
