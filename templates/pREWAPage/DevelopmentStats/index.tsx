      ...
      <div className="flex items-center -mx-20 mb-14 xl:-mx-10 lg:flex-col-reverse lg:items-stretch lg:mx-0 md:mb-8 pt-20 pb-20">
        ...
        <div className="w-[calc(50%-5rem)] mx-20 xl:w-[calc(50%-2.5rem)] xl:mx-10 lg:w-full lg:mx-0 lg:mb-10 md:mb-8">
          ...
          <div className="mb-12 text-greyscale-400 lg:mb-8 md:mb-6">
            Our platform development phase is actively underway. The team is
            constructing key network infrastructure and readying our initial
            services for launch, with our core approach already validated. We
            prioritize thorough testing and security. Supporting this ongoing
            work through the pREWA token sale will help bring these first
            offerings to smallholder farmers.
          </div>
