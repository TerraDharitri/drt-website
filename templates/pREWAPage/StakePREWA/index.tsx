  ...
  <div className="section bg-greyscale-25 dark:bg-dark-surface">
    <div className="container">
      <div className="text-center mb-20">
        <div className="mb-6 text-h2 text-start xl:text-h3 md:text-h4 dark:text-dark-text-primary">
          Stake pREWA: Earn Rewards
        </div>
        <div className="text-greyscale-400 text-start dark:text-dark-text-secondary text-lg md:text-base max-w-3xl ">
          pREWA offers immediate crypto staking utility from launch. This<br/>
