    ...
    <div className="container">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-h2 xl:text-h3 md:text-h4 text-start font-semibold mb-4 dark:text-dark-text-primary">
            Token Sale Proceeds Usage
          </h2>
          <p className="text-greyscale-400 text-start dark:text-dark-text-secondary text-lg md:text-base">
