      ...
      <div className="flex justify-center items-center grow pt-4 px-8 pb-16">
        <div className="max-w-[32.2rem] w-full text-center text-greyscale-0">
          ...
          <div className="mb-10 opacity-50 md:mb-6 md:text-lg">
            Lorem ipsum dolor sit amet consectetur. Sit sed turpis magna
            habitant leo ac ante. Quam volutpat vitae nisi
          </div>
          <Link className="btn-primary btn-md min-w-[16.5rem]" href="/sign-in">
            Back to Login
          </Link>
        </div>
      </div>
