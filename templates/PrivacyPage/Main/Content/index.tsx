...
const Content = ({}: ContentProps) => (
    <div className="content mt-16 pt-16 border-t border-greyscale-200 lg:mt-12 lg:pt-12 md:mt-8 md:pt-8">
        <p>
            Your privacy is important to us. It is Dharitri’s policy to respect
            ...
            including across our website, www.finto.com, and other sites we own
            and operate.
        </p>
        <p>
        ...
        <p>This policy is effective as of 31 October 2023.</p>
        ...
        <p>
            ...
            the purpose of publication on our website or re-publishing on our
            social media channels. All user-generated content is associated with
        ...
        <h5>Legitimate Reasons for Processing Your Personal Information</h5>
        <p>
