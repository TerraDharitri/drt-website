        ...
        >
          ...
          >
            <path
              ...
              className="fill-greyscale-900 dark:fill-dark-text-primary"
            />
          </svg>
        </Link>
        <Link
          ...
          {solutions.slice(1).map((solution, index) => (
            ...
            >
              <div className="w-[calc(50%-5rem)] mx-20 2xl:w-[calc(50%-2.5rem)] 2xl:mx-10 xl:w-[calc(50%-1.25rem)] xl:mx-5 lg:w-full lg:mx-0 lg:mb-10">
                ...
                {index >= 1 && (
                  <button
                    className="btn-primary pr-5 md:w-full flex items-center justify-center"
                    data-tally-open={
                      index === 1 ? "n9PBlY" : index === 2 ? "nPLpp1" : "nGaeAj"
                    }
