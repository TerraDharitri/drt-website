    ...
    <Dividers className="section bg-greyscale-25 dark:bg-dark-surface">
      <div className="py-10 text-center md:py-12">
        <div className="mb-15 text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-greyscale-400 dark:text-dark-text-secondary text-lg md:text-base">
            ...
            technology, development progress, and regenerative farming
            solutions.
          </p>
        </div>
      </div>
      <div className="container flex md:block">
        {/* <div className="shrink-0 w-[16.25rem] lg:w-44 md:flex md:w-auto md:mb-6 md:overflow-auto md:scroll-smooth md:scrollbar-none md:-mx-6 md:before:shrink-0 md:before:w-6 md:after:shrink-0 md:after:w-6">
          {faq.map((button) => (
            <button
              className={`flex w-full p-3 border border-transparent text-lg font-medium transition-colors hover:text-greyscale-900 dark:hover:text-dark-text-primary md:shrink-0 md:w-auto ${
                activeId === button.id
