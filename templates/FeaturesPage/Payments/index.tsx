    ...
    <div className="container">
      <div className="mb-16 lg:mb-12 md:mb-8">
        ...
        <div className="max-w-[46.6rem] text-greyscale-400">
          Optimized checkout suite delivers a frictionless customer experience.
          Increase revenue and save thousands of engineering hours with prebuilt
          payment
        </div>
      </div>
      <div className="flex flex-wrap -mt-6 -mx-3 lg:block lg:m-0 lg:space-y-8 md:space-y-6">
        {payments.map((item, index) => (
          ...
          >
            <div
              className={`p-2 ${index === 1 || index === 2 ? "mt-6" : "mb-6"}`}
            >
              <div className="mb-3 text-h6">{item.title}</div>
              <div className="text-lg text-greyscale-400">{item.content}</div>
            </div>
